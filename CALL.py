...
\x1b[92m    ┃╰━╯┃╭━╮┃╰━╯┃╰━╯┃\x1b[00m
''')
    phone = input('\x1b[96mเบอร์ที่ต้องการยิง\x1b[00m :\x1b[92m ')
    print ('')
    ...
    if int(phone) <= 99999999 or int(phone) >= 999999999:
         ...
         for i in range(1):
             ...
             if 'error' in snd.text or sed.text:
                  time.sleep(1)
                  print('\x1b[92m[ AONKY ]\x1b[00m : \x1b[96mกำลังยิงครับน้อง✓ \x1b[00m')
                  time.sleep(2)

             else:
                  time.sleep(1)
                  print('\x1b[92m[ AONKY ]\x1b[00m : \x1b[91mยิงเสร็จแล้วน้อง!\x1b[00m')
         time.sleep(1)
         print ('')
         hme = input('\x1b[92m[ AONKY ] : กดYนะไอสัส Y/N ?\x1b[00m \x1b[91m »\x1b[00m  \x1b[92m')
         print ('')
         if str(hme) == 'y' or str(hme) == 'Y':
              print('\x1b[92m[ AONKY ]\x1b[00m : \x1b[96mเรียบร้อย ~ \x1b[00m')
              time.sleep(2)
              os.system('clear')
              home()
         elif str(hme) == 'n' or str(hme) == 'N':
              print('\x1b[92m[ AONKY ]\x1b[00m : \x1b[96m √ \x1b[00m')
         else: print('\x1b[92m[ AONKY ]\x1b[00m : \x1b[91m X \x1b[00m')
